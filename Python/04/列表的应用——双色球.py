...
"""
rich库是一个用于在终端中创建美观输出的Python库。它提供了丰富的功能，如表格、进度条、文本样式等，可以让你的终端输出更加生动和有趣。在这个示例中，我们使用rich库创建了一个表格来展示生成的双色球号码。每注号码包含6个红球和1个蓝球，红球用红色显示，蓝球用蓝色显示。通过控制台输出表格，我们可以更清晰地看到每注号码的组成。
"""
